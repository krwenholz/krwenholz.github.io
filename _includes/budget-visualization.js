...
var _krwenholz$budget_visualization$DataStructureHelp$removeFromList = F2(
	function (i, xs) {
		return A2(
...
var _krwenholz$budget_visualization$DataStructureHelp$removeFromArray = function (i) {
	return function (_p0) {
		return _elm_lang$core$Array$fromList(
			A2(
				_krwenholz$budget_visualization$DataStructureHelp$removeFromList,
				i,
				_elm_lang$core$Array$toList(_p0)));
	};
};

var _krwenholz$budget_visualization$Account$readFloat = function (numberText) {
	var maybeFloat = _elm_lang$core$String$toFloat(numberText);
	var _p0 = maybeFloat;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
...
var _krwenholz$budget_visualization$Account$encodeIncomeEvent = function (_p1) {
	var _p2 = _p1;
	var jpercent = _elm_lang$core$Json_Encode$float(_p2.percentChange);
	var jflat = _elm_lang$core$Json_Encode$float(_p2.flatChange);
	var jname = _elm_lang$core$Json_Encode$string(_p2.name);
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'name', _1: jname},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'flatChange', _1: jflat},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'percentChange', _1: jpercent},
					_1: {ctor: '[]'}
				}
			}
		});
};
var _krwenholz$budget_visualization$Account$encode = function (_p3) {
	var _p4 = _p3;
	var encodedIncomeEvents = _elm_lang$core$Json_Encode$array(
		A2(_elm_lang$core$Array$map, _krwenholz$budget_visualization$Account$encodeIncomeEvent, _p4.incomeEvents));
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'initialValue',
					_1: _elm_lang$core$Json_Encode$float(_p4.initialValue)
				},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'incomeEvents', _1: encodedIncomeEvents},
					_1: {ctor: '[]'}
				}
			}
		});
};
var _krwenholz$budget_visualization$Account$emptyIncomeEvent = {name: 'Income Event', flatChange: 0.0, percentChange: 0.0};
var _krwenholz$budget_visualization$Account$init = {
	name: 'Account Name',
	initialValue: 10.0,
	incomeEvents: _elm_lang$core$Array$fromList(
		{
			ctor: '::',
			_0: _krwenholz$budget_visualization$Account$emptyIncomeEvent,
			_1: {ctor: '[]'}
		})
};
var _krwenholz$budget_visualization$Account$update = F2(
		...
		switch (_p5.ctor) {
			case 'NewIncomeEvent':
				return _elm_lang$core$Native_Utils.update(
					account,
					{
						incomeEvents: A2(_elm_lang$core$Array$push, _krwenholz$budget_visualization$Account$emptyIncomeEvent, account.incomeEvents)
					});
			case 'UpdateAccount':
				return _elm_lang$core$Native_Utils.update(
					account,
					{name: _p5._0.name, initialValue: _p5._0.initialValue});
			case 'UpdateIncomeEvent':
				return _elm_lang$core$Native_Utils.update(
					account,
					{
						incomeEvents: A3(_elm_lang$core$Array$set, _p5._0.eventNum, _p5._0.event, account.incomeEvents)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					account,
					{
						incomeEvents: A2(_krwenholz$budget_visualization$DataStructureHelp$removeFromArray, _p5._0, account.incomeEvents)
					});
		}
	});
var _krwenholz$budget_visualization$Account$UpdateAccountMsg = F2(
	function (a, b) {
		return {name: a, initialValue: b};
	});
var _krwenholz$budget_visualization$Account$UpdateIncomeEventMsg = F2(
	function (a, b) {
		return {eventNum: a, event: b};
	});
var _krwenholz$budget_visualization$Account$IncomeEvent = F3(
	function (a, b, c) {
		return {name: a, flatChange: b, percentChange: c};
	});
var _krwenholz$budget_visualization$Account$decodeIncomeEvent = A3(
	...
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_krwenholz$budget_visualization$Account$IncomeEvent))));
var _krwenholz$budget_visualization$Account$Model = F3(
	function (a, b, c) {
		return {name: a, initialValue: b, incomeEvents: c};
	});
var _krwenholz$budget_visualization$Account$decode = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'incomeEvents',
	_elm_lang$core$Json_Decode$array(_krwenholz$budget_visualization$Account$decodeIncomeEvent),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'initialValue',
		_elm_lang$core$Json_Decode$float,
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_krwenholz$budget_visualization$Account$Model))));
var _krwenholz$budget_visualization$Account$NewIncomeEvent = {ctor: 'NewIncomeEvent'};
var _krwenholz$budget_visualization$Account$DeleteIncomeEvent = function (a) {
	return {ctor: 'DeleteIncomeEvent', _0: a};
};
var _krwenholz$budget_visualization$Account$UpdateIncomeEvent = function (a) {
	return {ctor: 'UpdateIncomeEvent', _0: a};
};
var _krwenholz$budget_visualization$Account$updateIncomeEvent = F2(
	function (eventNum, incomeEvent) {
		return _krwenholz$budget_visualization$Account$UpdateIncomeEvent(
			{eventNum: eventNum, event: incomeEvent});
	});
var _krwenholz$budget_visualization$Account$incomeEventInput = F2(
	function (incomeEvent, index) {
		return A2(
...
var _krwenholz$budget_visualization$Account$incomeEventInputs = function (incomeEvents) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_elm_lang$core$Array$toList(
					A2(
						...
						F2(
							function (index, incomeEvent) {
								return A2(
									_elm_lang$html$Html$li,
									{ctor: '[]'},
									{
										ctor: '::',
										_0: A2(_krwenholz$budget_visualization$Account$incomeEventInput, incomeEvent, index),
										_1: {ctor: '[]'}
									});
							}),
						incomeEvents))),
...
var _krwenholz$budget_visualization$Account$UpdateAccount = function (a) {
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder(account.name),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(
								function (newName) {
									return _krwenholz$budget_visualization$Account$UpdateAccount(
										{name: newName, initialValue: account.initialValue});
								}),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _krwenholz$budget_visualization$Account$incomeEventInputs(account.incomeEvents),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _krwenholz$budget_visualization$BudgetMath$showData = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
...
var _krwenholz$budget_visualization$BudgetMath$valueAfterEvents = F2(
	function (incomeEvents, initialValue) {
		return A3(
			...
			_krwenholz$budget_visualization$BudgetMath$applyEvent(initialValue),
			initialValue,
			incomeEvents);
	});
var _krwenholz$budget_visualization$BudgetMath$expandAccount = F4(
	function (maxMonth, currentMonth, initialValue, incomeEvents) {
		if (_elm_lang$core$Native_Utils.eq(maxMonth, currentMonth)) {
			return {ctor: '[]'};
		} else {
			var value = A2(_krwenholz$budget_visualization$BudgetMath$valueAfterEvents, incomeEvents, initialValue);
			return {
				ctor: '::',
				_0: value,
				_1: A4(_krwenholz$budget_visualization$BudgetMath$expandAccount, maxMonth, currentMonth + 1, value, incomeEvents)
			};
		}
	});
var _krwenholz$budget_visualization$BudgetMath$AccountTrend = F2(
	function (a, b) {
		return {label: a, data: b};
	});
var _krwenholz$budget_visualization$BudgetMath$asData = function (accounts) {
	return {
		labels: A2(_elm_lang$core$List$range, 0, 120),
		datasets: _elm_lang$core$Array$toList(
			A2(
				_elm_lang$core$Array$map,
				function (_p6) {
					var _p7 = _p6;
					return A2(
						_krwenholz$budget_visualization$BudgetMath$AccountTrend,
						_p7.name,
						A4(_krwenholz$budget_visualization$BudgetMath$expandAccount, 120, 0, _p7.initialValue, _p7.incomeEvents));
				},
				accounts))
	};
};
var _krwenholz$budget_visualization$BudgetMath$view = function (accounts) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _krwenholz$budget_visualization$BudgetMath$showData(
				_krwenholz$budget_visualization$BudgetMath$asData(accounts)),
			_1: {ctor: '[]'}
		});
};
var _krwenholz$budget_visualization$BudgetMath$Model = F2(
	function (a, b) {
...
var _krwenholz$budget_visualization$BudgetVisualization$decode = _elm_lang$core$Json_Decode$array(_krwenholz$budget_visualization$Account$decode);
var _krwenholz$budget_visualization$BudgetVisualization$updateAccounts = F2(
	function (action, accounts) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'UpdateAccount':
				var _p1 = _p0._0.accountNum;
				var account = A2(
					_elm_lang$core$Maybe$withDefault,
					_krwenholz$budget_visualization$Account$init,
					A2(_elm_lang$core$Array$get, _p1, accounts));
				return A3(
					_elm_lang$core$Array$set,
					_p1,
					A2(_krwenholz$budget_visualization$Account$update, _p0._0.update, account),
					accounts);
			case 'DeleteAccount':
				return A2(_krwenholz$budget_visualization$DataStructureHelp$removeFromArray, _p0._0, accounts);
			case 'NewAccount':
				return A2(_elm_lang$core$Array$push, _krwenholz$budget_visualization$Account$init, accounts);
			default:
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeString, _krwenholz$budget_visualization$BudgetVisualization$decode, _p0._0);
				if (_p2.ctor === 'Err') {
					return _elm_lang$core$Array$fromList(
						{
							ctor: '::',
							_0: _krwenholz$budget_visualization$Account$init,
							_1: {ctor: '[]'}
						});
				} else {
					return _p2._0;
...
var _krwenholz$budget_visualization$BudgetVisualization$encode = function (model) {
	return _elm_lang$core$Json_Encode$array(
		A2(_elm_lang$core$Array$map, _krwenholz$budget_visualization$Account$encode, model));
};
var _krwenholz$budget_visualization$BudgetVisualization$copyModelJavascript = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			...
			A2(
				...
				0,
				_krwenholz$budget_visualization$BudgetVisualization$encode(model)),
			'\');'));
};
var _krwenholz$budget_visualization$BudgetVisualization$init = {
	ctor: '_Tuple2',
...
var _krwenholz$budget_visualization$BudgetVisualization$update = F2(
	function (action, accounts) {
		var updatedModel = A2(_krwenholz$budget_visualization$BudgetVisualization$updateAccounts, action, accounts);
		return {
			ctor: '_Tuple2',
			_0: updatedModel,
...
var _krwenholz$budget_visualization$BudgetVisualization$UpdateAcountMsg = F2(
	function (a, b) {
		return {accountNum: a, update: b};
	});
var _krwenholz$budget_visualization$BudgetVisualization$RestoreAccounts = function (a) {
	return {ctor: 'RestoreAccounts', _0: a};
};
var _krwenholz$budget_visualization$BudgetVisualization$NewAccount = {ctor: 'NewAccount'};
var _krwenholz$budget_visualization$BudgetVisualization$DeleteAccount = function (a) {
	return {ctor: 'DeleteAccount', _0: a};
};
var _krwenholz$budget_visualization$BudgetVisualization$UpdateAccount = function (a) {
	return {ctor: 'UpdateAccount', _0: a};
};
var _krwenholz$budget_visualization$BudgetVisualization$accountListItem = F2(
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$map,
								function (update) {
									return _krwenholz$budget_visualization$BudgetVisualization$UpdateAccount(
										{accountNum: index, update: update});
								},
								_krwenholz$budget_visualization$Account$view(account)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _krwenholz$budget_visualization$BudgetVisualization$accountsList = function (accounts) {
	return A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
		...
		_elm_lang$core$Array$toList(
			A2(
				...
				F2(
					function (index, account) {
						return A2(_krwenholz$budget_visualization$BudgetVisualization$accountListItem, index, account);
					}),
				accounts)));
};
var _krwenholz$budget_visualization$BudgetVisualization$view = function (accounts) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _krwenholz$budget_visualization$BudgetVisualization$accountsList(accounts),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Save for later'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Restore your saved session by pasting it here.'),
									_1: {
										ctor: '::',
...
var _krwenholz$budget_visualization$BudgetVisualization$main = _elm_lang$html$Html$program(
	{
		init: _krwenholz$budget_visualization$BudgetVisualization$init,
		update: _krwenholz$budget_visualization$BudgetVisualization$update,
		subscriptions: function (_p3) {
			return _elm_lang$core$Platform_Sub$none;
		},
		view: _krwenholz$budget_visualization$BudgetVisualization$view
	})();

var Elm = {};
Elm['Account'] = Elm['Account'] || {};
if (typeof _krwenholz$budget_visualization$Account$main !== 'undefined') {
    _krwenholz$budget_visualization$Account$main(Elm['Account'], 'Account', undefined);
}
Elm['BudgetMath'] = Elm['BudgetMath'] || {};
if (typeof _krwenholz$budget_visualization$BudgetMath$main !== 'undefined') {
    _krwenholz$budget_visualization$BudgetMath$main(Elm['BudgetMath'], 'BudgetMath', undefined);
}
Elm['BudgetVisualization'] = Elm['BudgetVisualization'] || {};
if (typeof _krwenholz$budget_visualization$BudgetVisualization$main !== 'undefined') {
    _krwenholz$budget_visualization$BudgetVisualization$main(Elm['BudgetVisualization'], 'BudgetVisualization', undefined);
}
Elm['DataStructureHelp'] = Elm['DataStructureHelp'] || {};
if (typeof _krwenholz$budget_visualization$DataStructureHelp$main !== 'undefined') {
    _krwenholz$budget_visualization$DataStructureHelp$main(Elm['DataStructureHelp'], 'DataStructureHelp', undefined);
}
